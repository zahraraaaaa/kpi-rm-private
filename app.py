...
# 
# # --- JUDUL ---
# st.markdown(f"<h1 style='text-align: center;'>📊 KPI RM Private Dashboard</h1>", unsafe_allow_html=True)
...
#     df['Status'] = df['Grand Total'].apply(lambda x: "Achieve ✅" if x >= 100 else "Not Achieve ❌")
# 
#     # --- VISUALISASI ---
#     m1, m2, m3 = st.columns(3)
#     m1.metric("Total RM", len(df))
#     m2.metric("Achieve", len(df[df['Status'] == "Achieve ✅"]))
...
#                       color_discrete_map={"Achieve ✅": "#2ecc71", "Not Achieve ❌": "#e74c3c"})
